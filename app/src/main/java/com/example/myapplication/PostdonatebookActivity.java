...
public class PostdonatebookActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_postdonatebook);
    }
    ...
    public void processpostdonatebookLinkCLick(View view) {
